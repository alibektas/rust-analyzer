...
use crate::{
    ...
    mir::{
        ...
        Interner, Local, LocalId, MemoryMap, MirBody, MirSpan, Mutability, Operand, OperandKind,
        Place, PlaceElem, PointerCast, ProjectionElem, ProjectionStore, RawIdx, Rvalue, Statement,
...
impl<'ctx> MirLowerCtx<'ctx> {
    ...
    fn lower_expr_to_some_operand(
        ...
        Ok(Some((Operand { kind: OperandKind::Copy(p), span: None }, current)))
    }
